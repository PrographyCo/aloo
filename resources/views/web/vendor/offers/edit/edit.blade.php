        ...
        <section class="section dashboard">
            <div class="card p-4">
                <div class="card-body">
                    ...
                    <form id="storeForm" method="POST" action="{{ route('vendor.offer.update',$offer) }}"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" name="name_ar" value="{{ $offer->name_ar }}" class="form-control w-100" id="name_ar" placeholder="{{ __('web/vendor/offers/create.name_ar') }}" required>
                                    <label for="name_ar">{{ __('web/vendor/offers/create.name_ar') }}</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <textarea class="form-control w-100 h-auto" id="description_ar" name="description_ar" placeholder="{{ __('web/vendor/offers/create.description_ar') }}" required rows="3">{{ $offer->description_ar }}</textarea>
                        ...
                        <div class="row g-3 mt-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" name="name_en" value="{{ $offer->name_en }}" class="form-control w-100" id="name_en" placeholder="{{ __('web/vendor/offers/create.name_en') }}" required>
                                    <label for="name_en">{{ __('web/vendor/offers/create.name_en') }}</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <textarea class="form-control w-100 h-auto" id="description_en" name="description_en" placeholder="{{ __('web/vendor/offers/create.description_en') }}" required rows="3">{{ $offer->description_en }}</textarea>
                        ...
                        <div class="row g-3 mt-3">
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <input type="text" name="price" value="{{ $offer->price }}" class="form-control w-100" id="price" placeholder="{{ __('web/vendor/offers/create.price') }}" required>
                                    <label for="price">{{ __('web/vendor/offers/create.price') }}</label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <input type="number" name="amount" value="{{ $offer->amount }}" class="form-control w-100" id="amount" placeholder="{{ __('web/vendor/offers/create.amount') }}" required>
                                ...
                                <div class="form-floating">
                                    <select class="form-select" id="category" name="category" aria-label="{{ __('web/vendor/offers/create.category') }}" required>
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}" @if($offer->category_id==$category->id) selected @endif>{{ $category->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-floating">
                                    <select class="form-select" id="category" name="size" aria-label="Size" required>
                                        ...
                                        @foreach(__('web/vendor/offers/create.sizes') as $key=>$value)
                                            <option value="{{ $key }}" @if($offer->size==$key) selected @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" id="optionals" name="with[]" aria-label="{{ __('web/vendor/offers/create.with') }}" multiple>
                                        <option value="">{{ __('web/vendor/offers/create.with') }}</option>
                                        @foreach($offer->with as $with)
                            ...
                            <div class="col-md">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" id="optionals2" name="without[]" aria-label="{{ __('web/vendor/offers/create.without') }}" multiple>
                                        <option value="">{{ __('web/vendor/offers/create.without') }}</option>
                                        @foreach($offer->without as $with)
                                            <option value="{{ $with }}" selected>{{ $with }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" id="extras" name="drinks[]" aria-label="{{ __('web/vendor/offers/create.drinks') }}" multiple>
                                        ...
                                        @foreach($drinks as $drink)
                                            <option value="{{ $drink->id }}" @if(in_array($drink->id,$offer->drinks)) selected @endif>{{ $drink->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" id="extras" name="extras[]" aria-label="{{ __('web/vendor/offers/create.extras') }}" multiple>
                                        ...
                                        @foreach($extras as $extra)
                                            <option value="{{ $extra->id }}" @if(in_array($extra->id,$offer->extras)) selected @endif>{{ $extra->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>

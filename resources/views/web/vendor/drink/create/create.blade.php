...
@section('main')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">add new drink</li>
                </ol>
            </nav>
        </div>
        ...
        <section class="section dashboard">
            <div class="card p-4">
                <div class="card-body">
                    <h5 class="card-title">{{ __('web/vendor/drink/create.main') }}</h5>
                    <form id="storeForm" method="POST" action="{{ route('vendor.drink.store') }}"

                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="form-floating">
                                <input type="text" name="name" class="form-control w-100" id="name" placeholder="{{ __('web/admin/driver/create.name') }}" required>
                                <label for="name">{{ __('web/admin/driver/create.name') }}</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-floating">
                                <input type="text" class="form-control w-100" id="phone" name="phone" placeholder="{{ __('web/admin/driver/create.phone') }}" required>
                                <label for="phone">{{  __('web/admin/driver/create.phone') }}</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-floating">
                                <input type="email" class="form-control w-100" name="email" id="email" placeholder="{{ __('web/admin/driver/create.email') }}">
                        ...
                        <div class="col-3">
                            <div class="form-floating">
                                <input type="text" name="bankRecipientName" class="form-control w-100" id="bankRecipientName" placeholder="{{ __('web/admin/vendor/create.bankRecipientName') }}" required>

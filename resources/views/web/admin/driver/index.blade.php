        ...
        <section class="section dashboard">
            <div class="card p-4">
                <div class="card-header">
                    <a class="rounded btn btn-primary" href="{{ route('admin.driver.create') }}">add new driver</a>
...
@push('scripts')
    <script>
        async function sendMoney(id,max) {
            let form = $('#send_money'), url = "{{ url('/admin/driver/::driver::/wallet') }}";
            form.prop('action', url.replace(/::driver::/g,id));

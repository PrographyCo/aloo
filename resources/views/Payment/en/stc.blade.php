...
<div class="sections mb-4">
    ...
    <div class="container">
        ...
        <div class="form  position-relative">
            <form class="m-auto form-owner" method="post" action="{{ route('payment.stc.verify',['lang'=>$lang,'token'=>$token]) }}">
                @error('public')
                ...
                <div class="input-group mb-3">
                    <input type="number" min="{{ $min }}" value="{{ $min }}" name="price" class="form-control" pattern="[0-9]{4,6}" placeholder="amount" required />

...
class CreateDriverWalletTracksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('driver_wallet_tracks', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('driver_wallet_tracks');
    }
}

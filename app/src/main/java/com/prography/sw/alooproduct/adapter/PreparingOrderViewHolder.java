...
public class PreparingOrderViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public PreparingOrderViewHolder(@NonNull View itemView, CustomListener customListener, CustomRecyclerViewAdapter.HolderConstants holderConstants) {
        super(itemView);
    ...
    public void onBind(OrderListTiem item) {
        ...
        // tv_Drink.setText(item.getData().getDrinks().get(0));
    ...
    public void onClick(View view) {
        customListener.onItemClick(getAdapterPosition(), "ITEM_PREPARING_ORDER");
    }
}

...
import com.prography.sw.alooproduct.databinding.ActivityStoreProductsResturantBinding;
...
public class StoreProductsResturantActivity extends AppCompatActivity implements CustomListener, View.OnClickListener {
    private ActivityStoreProductsResturantBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityStoreProductsResturantBinding.inflate(getLayoutInflater());
    ...
    private void initRestaurantAdapter() {
        adapter = new CustomRecyclerViewAdapter(this, CustomRecyclerViewAdapter.HolderConstants.RESTAURANTS_STORE_ITEM);
        adapter.setResturantStore(items);

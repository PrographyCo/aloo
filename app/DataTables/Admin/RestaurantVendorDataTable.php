...
class RestaurantVendorDataTable extends DataTable
{
    ...
    public function query(Vendor $model)
    {
        return $model
            ...
            ->with([
                'kitchenType:id,name_'.Controller::$lang.' as name',
                'restaurantType:id,name_'.Controller::$lang.' as name',
...
//            ->dom('Bfrtip')
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::computed('kitchenType[].name')->title(__('web/admin/datatable.vendor.kitchenType')),
            Column::computed('restaurantType[].name')->title(__('web/admin/datatable.vendor.restaurantType')),
    ...
    {
        return 'vendor_restaurant_' . date('YmdHis');
    }
}
